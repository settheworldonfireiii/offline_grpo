...
from deepscaler.data.dataset_types import TestDataset, TrainDataset
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--local_dir",
        default=os.path.expanduser("~/openr1/data"),
    ...
    train_dataset = datasets.load_dataset(
        "open-r1/OpenR1-Math-220k", split="train"
    )  # 94k    # filter the dataset
    ...
    def filter_target_length(example):
        ...
        for i, generation in enumerate(example["generations"]):
            generation_input_ids = tokenizer(generation, add_special_tokens=False)[
                "input_ids"
            ]
